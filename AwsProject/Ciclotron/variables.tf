variable "aws_region" {
  type = string
  description = "Nombre de región donde el recurso se creará o esta creado"
  default = "us-east-1"
}

variable "aws_profile" {
  type = string
  description = "Profile a utilizar para desplegar los recursos en AWS"
  default = "itera-test"
}
...
variable "tags" {
  ...
  default = {
    ...
    application    = ""
    environment    = ""
    createdBy      = "Manuel Gutierrez Aguirre"
    ceco           = ""
...
variable "name_pub_1a" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "name_pub_1b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "name_pri_1a" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "name_pri_2a" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "name_pri_1b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "name_pri_2b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
...
variable "aws_route_table_pub" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "aws_route_table_pub_1b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "aws_route_table_pri" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "aws_route_table_pri_2a" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "aws_route_table_pri_1b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
variable "aws_route_table_pri_2b" {
  description = "Name to be used on all the resources as identifier"
  type        = string
  default     = ""
}
...
variable "cidr_block_pri_1a" {
  description = "(Optional) The IPv4 CIDR block for the VPC. CIDR can be explicitly set or it can be derived from IPAM using `ipv4_netmask_length` & `ipv4_ipam_pool_id`"
  type        = string
  default     = ""
}
variable "cidr_block_pri_2a" {
  description = "(Optional) The IPv4 CIDR block for the VPC. CIDR can be explicitly set or it can be derived from IPAM using `ipv4_netmask_length` & `ipv4_ipam_pool_id`"
  type        = string
  default     = ""
}
variable "cidr_block_pri_1b" {
  description = "(Optional) The IPv4 CIDR block for the VPC. CIDR can be explicitly set or it can be derived from IPAM using `ipv4_netmask_length` & `ipv4_ipam_pool_id`"
  type        = string
  default     = ""
}
variable "cidr_block_pri_2b" {
  description = "(Optional) The IPv4 CIDR block for the VPC. CIDR can be explicitly set or it can be derived from IPAM using `ipv4_netmask_length` & `ipv4_ipam_pool_id`"
  type        = string
  default     = ""
}
